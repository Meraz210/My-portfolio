...
Education:
- American International University-Bangladesh (AIUB): B.Sc. in Computer Science and Engineering, 2022-Present. Expected Graduation: 2026.
- Cantonment Public School and College: Higher Secondary Certificate (HSC), 2019. GPA: 4.67 / 5.00.
- Lions School and College: Secondary School Certificate (SSC), 2017. GPA: 5.00 / 5.00.
- Visitors can explore the Education section (#education). Do not describe the bachelor's degree as completed or invent a university GPA.

Research thesis:
- Title: BDFD-10: A Bangladesh-Centric Multi-Class Fabric Defect Dataset and a Cross-Generation Benchmark of Deep Object Detectors.
- Period: 2025-2026, bachelor's research at AIUB.
- Developed a fabric defect dataset with 1,208 real-world images collected from four textile and garment factory groups.
- Benchmarked 10 object detection models under a unified evaluation protocol, including YOLOv8, YOLO11, YOLO12, YOLO26, RT-DETR-L, and Faster R-CNN.
- Achieved 93.2% mAP@0.5 using YOLOv8s; do not describe this metric as accuracy.
- Data preparation and evaluation tools: Python, PyTorch, Ultralytics YOLO, Roboflow, Google Colab.
- Visitors can explore the Thesis section (#thesis). No thesis paper URL or publication status has been provided.
- The resume is available via Download Resume in the hero and footer, or View Resume in the Thesis section. The PDF filename is MD_Meraz_Ahasan_Shah_Resume.pdf.
...
const intentHints = {
  thesis:
    "The visitor is asking about the BDFD-10 research thesis. Explain the dataset, model benchmark, and 93.2% mAP@0.5 result accurately. Refer to the Thesis section and resume without inventing a paper link or publication status.",
  resume:
    "The visitor wants the resume. Direct them to Download Resume in the hero or footer, or View Resume in the Thesis section.",
  education:
    "The visitor is asking about education. Use the university and school details, dates, and GPAs listed in the Education context. Keep the AIUB degree in progress with expected graduation in 2026, and refer to the Education section.",
  project:
...
const detectIntent = (message) => {
  ...
  if (/(thesis|research|bdfd|fabric|yolo|computer vision)/.test(lower)) return "thesis";
  if (/(resume|\bcv\b|curriculum vitae)/.test(lower)) return "resume";
  if (/(education|university|aiub|college|graduation|\bhsc\b|\bssc\b|\bgpa\b)/.test(lower)) return "education";
