...
const starterMessages = [
  {
    role: "assistant",
    text: "Hi, I am Meraz's portfolio assistant. I can help you explore his skills, projects, education, research thesis, resume, and contact options.",
  },
];
...
const localKnowledge = [
  {
    keys: ["thesis", "research", "bdfd", "fabric", "yolo", "computer vision"],
    followUp: "Explore the Thesis section for the benchmark highlights, or select View Resume to read the research summary.",
    reply:
      "Meraz's 2025-2026 thesis, BDFD-10, develops a Bangladesh-centric multi-class fabric defect dataset and benchmarks deep object detectors across generations. The dataset contains 1,208 real-world images from four textile and garment factory groups. He benchmarked 10 models under a unified evaluation protocol and achieved 93.2% mAP@0.5 with YOLOv8s. His pipeline uses Python, PyTorch, Ultralytics YOLO, Roboflow, and Google Colab.",
  },
  {
    keys: ["resume", "cv", "curriculum vitae"],
    followUp: "You can also select View Resume in the Thesis section to open the PDF.",
    reply:
      "Use Download Resume at the top of this website or in the footer to save Meraz's resume. It includes his software engineering skills, selected projects, BDFD-10 research thesis, and education.",
  },
  {
    keys: ["education", "university", "aiub", "college", "graduation", "hsc", "ssc", "gpa"],
    followUp: "Explore the Education section for his academic background.",
    reply:
      "Meraz is pursuing a B.Sc. in Computer Science and Engineering at American International University-Bangladesh (AIUB), 2022-Present, with expected graduation in 2026. He completed his Higher Secondary Certificate (HSC) at Cantonment Public School and College in 2019 with a GPA of 4.67 / 5.00, and his Secondary School Certificate (SSC) at Lions School and College in 2017 with a GPA of 5.00 / 5.00.",
  },
  {
...
const defaultLocalReply = {
  reply:
    "Meraz Ahasan is a Software Engineer based in Dhaka, Bangladesh. Ask about his projects, MERN skills, GitHub work, or contact details for a more specific answer.",
